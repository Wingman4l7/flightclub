...
public class Clock implements Runnable {
    ...
    */
    ...
    private float t_;
    /**
      Synchronises this client's copy of the model time 
	  with the master time held on the game server. 
    */
    ...
    /**
      Tune the frame rate up or down depending on 
	  how long we have been idle over the last N ticks. 
    */
