...
public class Tools3d {
    ...
    /** Returns a list of points for a circle lying in the XY plane. */
	...
	that it lies on the x axis. We do the transformation in two steps.
	First, rotate about z axis (so the point lies in the plane y = 0). 
	Second, rotate about y axis (so the point lies in the plane z = 0).  
    */
    ...
    */
    ...
    /**
	   ...
	   Then look up a pre-computed value from array.
    */
    ...
    /**
       Prints out the tokens in a stream. Useful for debugging.
       This class has become the home of static utility methods!
    */
