...
/**
   This class manages all the gliders (user, networked and AI). 
   The user's glider is the first in the list.
 */ 
public class GliderManager implements ClockObserver {
    ...
    */
    ...
    /** 
	  Returns the glider to watch in camera view #2. 
	  As this function is called we cycle round the gaggle gliders.
	*/
    Glider gaggleGlider() {
    ...
    */
    ...
    ////////////////////////////////////////////////////////////////////////
    //   Networking stuff from Artem Nikulchev <jaguart@paragliding.ru>   //
    ////////////////////////////////////////////////////////////////////////
