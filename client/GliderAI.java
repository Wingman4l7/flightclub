...
/**
  ...
  TODO: When to climb and when to glide to a *better* climb?
  Also, a rule that if h < h1 then be *cautious*?
...
public class GliderAI extends GliderTask {
    ...
    /**
       ...
       TODO: A better design would not keep checking every tick, 
	   but use a call back?
    */
    protected void tickAI(float t) {
		...
		// otherwise, review me last decision every so often - 
		// perhaps we can now reach a better climb?
		if (t > t_ + T_THINK) {
			reviewDecision(t);	    
		}
    }
    ...
    /**
       ...
       a bit fiddly. The glide angle will be reduced by any head wind etc.
    */
    ...
    */
    ...
    /**
       How long to get to a cloud. Note we may ignore the wind as 
       both the cloud and the glider experience the same drift.
    */
