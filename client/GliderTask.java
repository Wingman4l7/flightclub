...
/**
   Adds next turn point to glider state. 
   This class contains stuff common to GliderUser and GliderAI.
*/
public class GliderTask extends Glider {
    ...
    /**
       ...
       the last turn point, A, from the task start and add the distance
       that we are away from A in the direction of the next turn point, B.
    */
    ...
    /**
       Returns a text message giving current state of glider. 
	   Note the formatting of model units for human consumption...
    ...
    */
    ...
    /**
       Sets the camera focus and eye. The glider should not 
	   sit at the center of the screen. Rather...
