...
/**
   Creates the turn points. Gets data by parsing the stream of tokens. 
   Or creates default data if no stream is passed in.
*/
class TurnPointManager {
    ...
    /**  Makes a double linked list - sets next and prev for each item in the list of turn points.  */
