...
/**
   ...
   releases a bubble of warm air that floats up to produce a cloud.
   Well, that is the impression we hopefully evoke.

   The trigger model contains lots of dubious assumptions 
   and gross simplifications. Good!
...
public class Trigger implements ClockObserver, CameraSubject {
    ...
    */
    ...
    /**
       Makes the trigger sleep. When asleep the trigger
       will not be rendered and does not produce any clouds.
     */
    void sleep(float t) {
		if (mode == SLEEPING) {
			return;
    ...
    */
    ...
    /**
       ...
       We draw a square on the ground whose shade varies from white to
       black as a function of thermalStrength.
     */
    private Obj3d obj3d;
