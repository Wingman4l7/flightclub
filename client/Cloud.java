...
/**
   ...
   Inside the inner class Shape3d we work in spherical polars. 
...
public class Cloud implements CameraSubject, ClockObserver, LiftSource {
    ...
    // TODO: cloud params - separate size from strength (see Trigger)
    ...
    */
    ...
    /**
	   ...
	   By 'under' we mean within the sloping column of 
	   rising air that is feeding  this cloud.  
    */
    ...
    /** Returns life span for a given size of cloud. Redundant now? */
	...
	The lift is a function of r, the distance from the thermal center:
    ...
    */
    ...
    /**
	   ...
	   A thermal gets blown downwind as it climbs.  
    ...
    */
    ...
    /**
       ...
       Ok, so it doesn't look much like a cloud !
	   But it looks a bit like one cell of a cloud. 
    ...
    */
    class Shape3d {
		...
		// pre compute some trig functions
		...
		*/
		...
		/**
		   Return co-ords of a vertex. 
		   See the *class* comments for an explanation of the vertex labelling.  
		*/
		...
		private void addPolygons() {
			...
			/* 
				Add the 6 polygons. 
				See the class comments above for an explanation of the vertex labelling. 
			*/
			...
			// top, bottom 
			/*
			  The top is bent (the four vertices do not lie in a plane).
			  The bottom is a lighter color (because the cloud lets light thru' from above). 
			*/
    ...
    */
    class LifeCycle {
		...
		/**
		   Sets time from birth until the end of each stage. 
		   The times are a linear fn of the cloud size.  
		*/
