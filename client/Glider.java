...
public class Glider extends MovingBody {
    ...
    */
    public Glider(XCModelViewer xcModelViewer, GliderType gliderType, int id) {
		...
		/*
		   ...
		   TODO: 1. Make wind an observable that may change through the day.  
		   2. Introduce wind shear - task designer may divide air vertically into *two* layers.
		*/
    ...
    */
    ...
    /**
       ...
       enables a glider to positioned on the ground ready for take off.
     */
    public void takeOff() { 
		takeOff(true); 
	}
    ...
    */
    ...
    /**
       ...
       See GliderAI for user friendly stuff. This is for debug.
    */
    ...
    /**
       Sets the drone flag so this glider maintains a contstant height.
       Handy for testing ? 
    */
    void makeDrone() {	
		drone = true; 
