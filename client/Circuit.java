/*
  @(#)Circuit.java (part of 'Flight Club')
...
/**
   A list of points to fly round when ridge soaring.  Usually two points, 
   unless ridge is snakey.  NB We use the hill's local coord system.
...
class Circuit {
    ...
    /**
       Returns the next point on the circuit. 
	   Or null if we have reached the end of the circuit.
    */
    float[] next() {
		float[] p;
