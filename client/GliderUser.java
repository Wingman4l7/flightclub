...
public class GliderUser extends GliderTask implements EventInterface {
    ...
    */
    ...
    private int _iP = 0;
    /**
       Send to server the values of p, vx, vy, iP and the next move.
       We only do this if either nextTurn has changed or iP has
    ...
    */
    ...
    /**
       Allows camera man to either follow the glider from behind
	   or look from the point of view of the pilot.
    */
