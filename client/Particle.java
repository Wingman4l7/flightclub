...
class Particle implements ClockObserver, CameraSubject {
    ...
    /** 
        ...
        are protected so you must be a subclass to change their values.  
    ...
    */
	...
	<p>This method is only used by the GliderNetworked 
	which gets p and v from the game server. 
    ...
    */
    ...
    /**
       ...
       <code>tick</code> if <code>nextTurn</code> has a non zero value.  
    */
    ...
    /** see MovementManager - for speed we don't want to calculate sH unless we have to. */
