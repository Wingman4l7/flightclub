/*
  @(#)XCNet.java (part of 'Flight Club')
  
  Includes contributions from Artem Nikulchev (jaguart@paragliding.ru), 
  a paraglider pilot from Moscow.  Presumably, the below still applies:
...
public class XCNet implements Runnable {
    ...
    /**
       Returns the glider id which appears before '>' in messages from the server.
        We ignore the leading '+' (which appears in in welcome messages).
