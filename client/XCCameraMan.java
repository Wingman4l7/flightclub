...
/**
   This class adds some XC functions to the cameraman (eg. camera modes).
*/
class XCCameraMan extends CameraMan {
    ...
    */
    ...
    /**
       Returns text for user feedback. 
	   We append the pilot ID of the glider that is currently being filmed.
    */
    String getStatusMsg() {
